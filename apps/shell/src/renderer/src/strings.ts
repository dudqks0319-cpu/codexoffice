...
export const strings = {
  zh: {
    ...
    colSize: '大小',
    // Quick start
    newDoc: 'Codexoffice Docs',
    newSheet: 'Codexoffice Sheets',
    newSlide: 'Codexoffice Slides',
    openLocal: '打开本地文件',
    greetMorning: '早上好',
    greetAfternoon: '下午好',
    greetEvening: '晚上好',
    ...
    noContent: '（无内容）',
    // Account
    accountCodex: '此应用的 Codex 账号',
    codexAccount: 'Codex 账号',
    account: '账号',
    login: '登录',
    loginCodex: '在此应用中登录 Codex',
    loggedIn: '已登录',
    loggedInCodex: '已在此应用中登录 Codex',
    ...
    loginCopyUrl: '复制登录链接',
    loginCopied: '已复制',
    loginNetworkError: '无法连接 Codex，请检查网络或代理设置',
    ...
    onbTitle1: '欢迎使用 Codexoffice',
    onbSubtitle1: '第一个开源的 AI 原生 Office 套件',
    onbBody1: '创建文档、制作表格、生成演示、审阅 PDF。AI 深度融入每个环节。',
    onbTitle2: '连接 Codex',
    onbBody2: '使用 AI 前，请在此应用中使用你的 ChatGPT / OpenAI 账号登录 Codex。',
    onbAccountNote: '**Codex 登录仅保存在此应用中。** 不会使用或更改其他 Codex 会话。',
    onbSkip: '跳过',
    onbNext: '下一步',
    onbStart: '开始使用',
    ...
    onbNote3: 'AI 使用量受你的 OpenAI 套餐和使用限制约束。',
    onbBack: '上一步',
  },
  en: {
    navRecent: 'Recent',
    ...
    untitled: 'Untitled',
    noContent: '(empty)',
    accountCodex: 'Codex account for this app',
    codexAccount: 'Codex account',
    account: 'Account',
    login: 'Sign in',
    loginCodex: 'Sign in to Codex in this app',
    loggedIn: 'Signed in',
    loggedInCodex: 'Signed in to Codex in this app',
    ...
    newTab: 'New tab',
    // First-run onboarding
    onbTitle1: 'Welcome to Codexoffice',
    ...
    onbTitle2: 'Connect Codex',
    onbBody2: 'Before using AI, sign in to Codex in this app with your ChatGPT / OpenAI account.',
    onbAccountNote:
      '**Codex sign-in stays in this app.** It does not use or change other Codex sessions.',
    onbSkip: 'Skip',
    onbNext: 'Next',
    ...
    onbNote3: 'AI usage follows your OpenAI plan and usage limits.',
    onbBack: 'Back',
  },
  ja: {
    // Sidebar navigation
    ...
    noContent: '（内容なし）',
    // Account
    accountCodex: 'このアプリの Codex アカウント',
    codexAccount: 'Codex アカウント',
    account: 'アカウント',
    login: 'サインイン',
    loginCodex: 'このアプリで Codex にサインイン',
    loggedIn: 'サインイン済み',
    loggedInCodex: 'このアプリで Codex にサインイン済み',
    waitingLogin:
    ...
    newTab: '新しいタブ',
    // First-run onboarding
    onbTitle1: 'Codexoffice へようこそ',
    onbSubtitle1: '初のオープンソース AI ネイティブ Office スイート',
    onbBody1:
      '文書の作成、表計算、プレゼン作成、PDF のレビュー。あらゆるステップに AI が組み込まれています。',
    onbTitle2: 'Codex に接続',
    onbBody2:
      'AI を使用する前に、このアプリで ChatGPT / OpenAI アカウントを使って Codex にサインインしてください。',
    onbAccountNote:
      '**Codex のサインインはこのアプリ内だけに保存されます。** 他の Codex セッションは使用・変更しません。',
    onbSkip: 'スキップ',
    onbNext: '次へ',
    onbStart: 'はじめる',
    ...
    onbNote3: 'AI の利用量には OpenAI プランと使用制限が適用されます。',
    onbBack: '戻る',
  },
  ko: {
    // Sidebar navigation
    ...
    noContent: '(내용 없음)',
    // Account
    accountCodex: '이 앱의 Codex 계정',
    codexAccount: 'Codex 계정',
    account: '계정',
    login: '로그인',
    loginCodex: '이 앱에서 Codex에 로그인',
    loggedIn: '로그인됨',
    loggedInCodex: '이 앱에서 Codex에 로그인됨',
    ...
    loginCopied: '복사됨',
    loginNetworkError: 'Codex에 연결할 수 없습니다. 네트워크 또는 프록시 설정을 확인하세요',
    ...
    newTab: '새 탭',
    // First-run onboarding
    onbTitle1: 'Codexoffice에 오신 것을 환영합니다',
    onbSubtitle1: '최초의 오픈소스 AI 네이티브 오피스 제품군',
    onbBody1:
      '문서 작성, 스프레드시트 제작, 프레젠테이션 생성, PDF 검토. 모든 단계에 AI가 녹아 있습니다.',
    onbTitle2: 'Codex 연결',
    onbBody2: 'AI를 사용하기 전에 이 앱에서 ChatGPT / OpenAI 계정으로 Codex에 로그인하세요.',
    onbAccountNote:
      '**Codex 로그인은 이 앱에만 저장됩니다.** 다른 Codex 세션을 사용하거나 변경하지 않습니다.',
    onbSkip: '건너뛰기',
    onbNext: '다음',
    onbStart: '시작하기',
    ...
    onbNote3: 'AI 사용량에는 OpenAI 요금제와 사용 한도가 적용됩니다.',
    onbBack: '이전',
  },
  fr: {
    // Sidebar navigation
    ...
    noContent: '(vide)',
    // Account
    accountCodex: 'Compte Codex de cette application',
    codexAccount: 'Compte Codex',
    account: 'Compte',
    login: 'Se connecter',
    loginCodex: 'Se connecter à Codex dans cette application',
    loggedIn: 'Connecté',
    loggedInCodex: 'Connecté à Codex dans cette application',
    waitingLogin:
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenue dans Codexoffice',
    ...
    onbTitle2: 'Connecter Codex',
    onbBody2:
      'Avant d’utiliser l’IA, connectez-vous à Codex dans cette application avec votre compte ChatGPT / OpenAI.',
    onbAccountNote:
      '**La connexion Codex reste dans cette application.** Elle n’utilise ni ne modifie les autres sessions Codex.',
    onbSkip: 'Passer',
    onbNext: 'Suivant',
    onbStart: 'Commencer',
    ...
    onbNote3: 'L’utilisation de l’IA suit votre forfait OpenAI et ses limites.',
    onbBack: 'Retour',
  },
  de: {
    // Sidebar navigation
    ...
    noContent: '(leer)',
    // Account
    accountCodex: 'Codex-Konto dieser App',
    codexAccount: 'Codex-Konto',
    account: 'Konto',
    login: 'Anmelden',
    loginCodex: 'Codex in dieser App anmelden',
    loggedIn: 'Angemeldet',
    loggedInCodex: 'Codex ist in dieser App angemeldet',
    waitingLogin:
    ...
    loginCopied: 'Kopiert',
    loginNetworkError: 'Codex ist nicht erreichbar — prüfen Sie Netzwerk- oder Proxy-Einstellungen',
    ...
    loggingOut: 'Abmelden…',
    logout: 'Nur von dieser App abmelden',
    appVersion: 'Version {v}',
    versionLabel: 'Version',
    // Dates
    today: 'Heute',
    ...
    newTab: 'Neuer Tab',
    // First-run onboarding
    onbTitle1: 'Willkommen bei Codexoffice',
    ...
    onbTitle2: 'Codex verbinden',
    onbBody2:
      'Melden Sie sich vor der KI-Nutzung in dieser App mit Ihrem ChatGPT-/OpenAI-Konto bei Codex an.',
    onbAccountNote:
      '**Die Codex-Anmeldung bleibt in dieser App.** Andere Codex-Sitzungen werden weder verwendet noch geändert.',
    ...
    onbNote3: 'Die KI-Nutzung richtet sich nach Ihrem OpenAI-Tarif und dessen Limits.',
    onbBack: 'Zurück',
  },
  es: {
    // Sidebar navigation
    ...
    noContent: '(vacío)',
    // Account
    accountCodex: 'Cuenta de Codex de esta aplicación',
    codexAccount: 'Cuenta de Codex',
    account: 'Cuenta',
    login: 'Iniciar sesión',
    loginCodex: 'Iniciar sesión en Codex en esta aplicación',
    loggedIn: 'Sesión iniciada',
    loggedInCodex: 'Sesión de Codex iniciada en esta aplicación',
    waitingLogin:
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'No se puede conectar con Codex — compruebe su red o la configuración del proxy',
    ...
    logout: 'Cerrar sesión solo en esta aplicación',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenido a Codexoffice',
    ...
    onbTitle2: 'Conectar Codex',
    onbBody2:
      'Antes de usar la IA, inicia sesión en Codex dentro de esta aplicación con tu cuenta de ChatGPT / OpenAI.',
    onbAccountNote:
      '**La sesión de Codex permanece en esta aplicación.** No usa ni modifica otras sesiones de Codex.',
    onbSkip: 'Omitir',
    onbNext: 'Siguiente',
    onbStart: 'Empezar',
    ...
    onbNote3: 'El uso de IA sigue tu plan de OpenAI y sus límites.',
    onbBack: 'Atrás',
  },
  th: {
    // Sidebar navigation
    ...
    // Account
    accountCodex: 'บัญชี Codex สำหรับแอปนี้',
    codexAccount: 'บัญชี Codex',
    account: 'บัญชี',
    login: 'ลงชื่อเข้าใช้',
    loginCodex: 'ลงชื่อเข้าใช้ Codex ในแอปนี้',
    loggedIn: 'ลงชื่อเข้าใช้แล้ว',
    loggedInCodex: 'ลงชื่อเข้าใช้ Codex ในแอปนี้แล้ว',
    ...
    loginNetworkError: 'ไม่สามารถเชื่อมต่อ Codex ได้ โปรดตรวจสอบเครือข่ายหรือการตั้งค่าพร็อกซี',
    ...
    newTab: 'แท็บใหม่',
    // First-run onboarding
    onbTitle1: 'ยินดีต้อนรับสู่ Codexoffice',
    ...
    onbTitle2: 'เชื่อมต่อ Codex',
    onbBody2: 'ก่อนใช้ AI ให้ลงชื่อเข้าใช้ Codex ในแอปนี้ด้วยบัญชี ChatGPT / OpenAI',
    onbAccountNote:
      '**การลงชื่อเข้าใช้ Codex จะอยู่ในแอปนี้เท่านั้น** โดยไม่ใช้หรือเปลี่ยนเซสชัน Codex อื่น',
    onbSkip: 'ข้าม',
    onbNext: 'ถัดไป',
    ...
    onbNote3: 'การใช้ AI เป็นไปตามแผน OpenAI และขีดจำกัดการใช้งานของคุณ',
    onbBack: 'ย้อนกลับ',
  },
  id: {
    // Sidebar navigation
    ...
    noContent: '(kosong)',
    // Account
    accountCodex: 'Akun Codex untuk aplikasi ini',
    codexAccount: 'Akun Codex',
    account: 'Akun',
    login: 'Masuk',
    loginCodex: 'Masuk ke Codex di aplikasi ini',
    loggedIn: 'Sudah masuk',
    loggedInCodex: 'Sudah masuk ke Codex di aplikasi ini',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat terhubung ke Codex — periksa jaringan atau pengaturan proxy Anda',
    loginExpired: 'Otorisasi kedaluwarsa — klik untuk mencoba lagi',
    loginFailed: 'Login gagal — klik untuk mencoba lagi',
    loggingOut: 'Keluar…',
    logout: 'Keluar hanya dari aplikasi ini',
    appVersion: 'Versi {v}',
    versionLabel: 'Versi',
    // Dates
    today: 'Hari ini',
    ...
    newTab: 'Tab baru',
    // First-run onboarding
    onbTitle1: 'Selamat datang di Codexoffice',
    ...
    onbTitle2: 'Hubungkan Codex',
    onbBody2:
      'Sebelum menggunakan AI, masuk ke Codex di aplikasi ini dengan akun ChatGPT / OpenAI Anda.',
    onbAccountNote:
      '**Login Codex tetap berada di aplikasi ini.** Login ini tidak menggunakan atau mengubah sesi Codex lain.',
    onbSkip: 'Lewati',
    onbNext: 'Berikutnya',
    onbStart: 'Mulai',
    ...
    onbNote3: 'Penggunaan AI mengikuti paket OpenAI dan batas penggunaan Anda.',
    onbBack: 'Kembali',
  },
  ru: {
    // Sidebar navigation
    ...
    noContent: '(пусто)',
    // Account
    accountCodex: 'Учётная запись Codex в этом приложении',
    codexAccount: 'Учётная запись Codex',
    account: 'Учётная запись',
    login: 'Войти',
    loginCodex: 'Войти в Codex в этом приложении',
    loggedIn: 'Вход выполнен',
    loggedInCodex: 'Выполнен вход в Codex в этом приложении',
    ...
    loginNetworkError: 'Не удаётся подключиться к Codex — проверьте сеть или настройки прокси',
    loginExpired: 'Срок авторизации истёк — нажмите, чтобы повторить',
    loginFailed: 'Не удалось войти — нажмите, чтобы повторить',
    loggingOut: 'Выход…',
    logout: 'Выйти только из этого приложения',
    appVersion: 'Версия {v}',
    versionLabel: 'Версия',
    // Dates
    today: 'Сегодня',
    ...
    // First-run onboarding
    onbTitle1: 'Добро пожаловать в Codexoffice',
    ...
    onbTitle2: 'Подключите Codex',
    onbBody2:
      'Перед использованием ИИ войдите в Codex в этом приложении через учётную запись ChatGPT / OpenAI.',
    onbAccountNote:
      '**Вход в Codex сохраняется только в этом приложении.** Другие сеансы Codex не используются и не изменяются.',
    onbSkip: 'Пропустить',
    onbNext: 'Далее',
    onbStart: 'Начать',
    ...
    onbNote3: 'Использование ИИ зависит от вашего тарифа OpenAI и его лимитов.',
    onbBack: 'Назад',
  },
  ar: {
    // Sidebar navigation
    ...
    noContent: '(فارغ)',
    // Account
    accountCodex: 'حساب Codex لهذا التطبيق',
    codexAccount: 'حساب Codex',
    account: 'الحساب',
    login: 'تسجيل الدخول',
    loginCodex: 'تسجيل الدخول إلى Codex في هذا التطبيق',
    loggedIn: 'تم تسجيل الدخول',
    loggedInCodex: 'تم تسجيل الدخول إلى Codex في هذا التطبيق',
    ...
    loginNetworkError: 'تعذّر الاتصال بـ Codex — تحقق من الشبكة أو إعدادات الوكيل',
    loginExpired: 'انتهت صلاحية التفويض — انقر لإعادة المحاولة',
    loginFailed: 'فشل تسجيل الدخول — انقر لإعادة المحاولة',
    loggingOut: 'جارٍ تسجيل الخروج…',
    logout: 'تسجيل الخروج من هذا التطبيق فقط',
    ...
    // First-run onboarding
    onbTitle1: 'مرحبًا بك في Codexoffice',
    ...
    onbTitle2: 'ربط Codex',
    onbBody2:
      'قبل استخدام الذكاء الاصطناعي، سجّل الدخول إلى Codex في هذا التطبيق بحساب ChatGPT / OpenAI.',
    onbAccountNote:
      '**يبقى تسجيل دخول Codex داخل هذا التطبيق.** ولا يستخدم جلسات Codex الأخرى أو يغيّرها.',
    onbSkip: 'تخطي',
    onbNext: 'التالي',
    onbStart: 'ابدأ الآن',
    ...
    onbNote3: 'يخضع استخدام الذكاء الاصطناعي لخطة OpenAI وحدود الاستخدام الخاصة بك.',
    onbBack: 'رجوع',
  },
  pt: {
    navRecent: 'Recentes',
    ...
    untitled: 'Sem título',
    noContent: '(vazio)',
    accountCodex: 'Conta Codex deste aplicativo',
    codexAccount: 'Conta Codex',
    account: 'Conta',
    login: 'Entrar',
    loginCodex: 'Entrar no Codex neste aplicativo',
    loggedIn: 'Conectado',
    loggedInCodex: 'Conectado ao Codex neste aplicativo',
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'Não foi possível conectar ao Codex — verifique sua rede ou as configurações de proxy',
    loginExpired: 'A autorização expirou — clique para tentar novamente',
    loginFailed: 'Falha no login — clique para tentar novamente',
    loggingOut: 'Saindo…',
    logout: 'Sair somente deste aplicativo',
    appVersion: 'Versão {v}',
    versionLabel: 'Versão',
    today: 'Hoje',
    yesterday: 'Ontem',
    ...
    newTab: 'Nova guia',
    // First-run onboarding
    onbTitle1: 'Bem-vindo ao Codexoffice',
    ...
    onbTitle2: 'Conectar o Codex',
    onbBody2: 'Antes de usar IA, entre no Codex neste aplicativo com sua conta ChatGPT / OpenAI.',
    onbAccountNote:
      '**O login do Codex permanece neste aplicativo.** Ele não usa nem altera outras sessões do Codex.',
    onbSkip: 'Pular',
    onbNext: 'Avançar',
    onbStart: 'Começar',
    onbStepAria: 'Página {n} de {total}',
    ...
    onbNote3: 'O uso de IA segue seu plano OpenAI e os limites de uso.',
    onbBack: 'Voltar',
  },
  it: {
    navRecent: 'Recenti',
    ...
    noContent: '(vuoto)',
    accountCodex: 'Account Codex di questa app',
    codexAccount: 'Account Codex',
    account: 'Account',
    login: 'Accedi',
    loginCodex: 'Accedi a Codex in questa app',
    loggedIn: 'Accesso effettuato',
    loggedInCodex: 'Accesso a Codex effettuato in questa app',
    ...
    loginCopied: 'Copiato',
    loginNetworkError:
      'Impossibile raggiungere Codex — controlla la rete o le impostazioni del proxy',
    ...
    logout: 'Esci solo da questa app',
    ...
    newTab: 'Nuova scheda',
    // First-run onboarding
    onbTitle1: 'Benvenuto in Codexoffice',
    ...
    onbTitle2: 'Collega Codex',
    onbBody2:
      'Prima di usare l’IA, accedi a Codex in questa app con il tuo account ChatGPT / OpenAI.',
    onbAccountNote:
      '**L’accesso a Codex resta in questa app.** Non usa né modifica altre sessioni Codex.',
    onbSkip: 'Salta',
    onbNext: 'Avanti',
    onbStart: 'Inizia',
    ...
    onbNote3: 'L’uso dell’IA segue il tuo piano OpenAI e i relativi limiti.',
    onbBack: 'Indietro',
  },
  pl: {
    navRecent: 'Ostatnie',
    ...
    untitled: 'Bez tytułu',
    noContent: '(pusto)',
    accountCodex: 'Konto Codex tej aplikacji',
    codexAccount: 'Konto Codex',
    account: 'Konto',
    login: 'Zaloguj się',
    loginCodex: 'Zaloguj się do Codex w tej aplikacji',
    loggedIn: 'Zalogowano',
    loggedInCodex: 'Zalogowano do Codex w tej aplikacji',
    waitingLogin:
    ...
    loginNetworkError: 'Nie można połączyć się z Codex — sprawdź sieć lub ustawienia proxy',
    ...
    logout: 'Wyloguj się tylko z tej aplikacji',
    appVersion: 'Wersja {v}',
    versionLabel: 'Wersja',
    today: 'Dzisiaj',
    yesterday: 'Wczoraj',
    ...
    newTab: 'Nowa karta',
    // First-run onboarding
    onbTitle1: 'Witamy w Codexoffice',
    ...
    onbTitle2: 'Połącz Codex',
    onbBody2: 'Przed użyciem AI zaloguj się do Codex w tej aplikacji kontem ChatGPT / OpenAI.',
    onbAccountNote:
      '**Logowanie Codex pozostaje w tej aplikacji.** Nie używa ani nie zmienia innych sesji Codex.',
    onbSkip: 'Pomiń',
    onbNext: 'Dalej',
    onbStart: 'Rozpocznij',
    ...
    onbNote3: 'Korzystanie z AI podlega planowi OpenAI i jego limitom.',
    onbBack: 'Wstecz',
  },
  nl: {
    navRecent: 'Recent',
    ...
    untitled: 'Naamloos',
    noContent: '(leeg)',
    accountCodex: 'Codex-account voor deze app',
    codexAccount: 'Codex-account',
    account: 'Account',
    login: 'Inloggen',
    loginCodex: 'Inloggen bij Codex in deze app',
    loggedIn: 'Ingelogd',
    loggedInCodex: 'Ingelogd bij Codex in deze app',
    ...
    loginNetworkError: 'Kan Codex niet bereiken — controleer uw netwerk of proxyinstellingen',
    ...
    logout: 'Alleen uitloggen bij deze app',
    appVersion: 'Versie {v}',
    versionLabel: 'Versie',
    today: 'Vandaag',
    yesterday: 'Gisteren',
    ...
    // First-run onboarding
    onbTitle1: 'Welkom bij Codexoffice',
    ...
    onbTitle2: 'Codex verbinden',
    onbBody2:
      'Meld u voordat u AI gebruikt in deze app aan bij Codex met uw ChatGPT-/OpenAI-account.',
    onbAccountNote:
      '**De Codex-aanmelding blijft in deze app.** Andere Codex-sessies worden niet gebruikt of gewijzigd.',
    onbSkip: 'Overslaan',
    onbNext: 'Volgende',
    ...
    onbNote3: 'AI-gebruik volgt uw OpenAI-abonnement en gebruikslimieten.',
    onbBack: 'Terug',
  },
  ms: {
    navRecent: 'Terkini',
    ...
    noContent: '(kosong)',
    accountCodex: 'Akaun Codex untuk aplikasi ini',
    codexAccount: 'Akaun Codex',
    account: 'Akaun',
    login: 'Log masuk',
    loginCodex: 'Log masuk ke Codex dalam aplikasi ini',
    loggedIn: 'Telah log masuk',
    loggedInCodex: 'Telah log masuk ke Codex dalam aplikasi ini',
    ...
    loginCopied: 'Disalin',
    loginNetworkError: 'Tidak dapat menyambung ke Codex — semak rangkaian atau tetapan proksi anda',
    ...
    logout: 'Log keluar daripada aplikasi ini sahaja',
    appVersion: 'Versi {v}',
    versionLabel: 'Versi',
    today: 'Hari ini',
    yesterday: 'Semalam',
    ...
    newTab: 'Tab baharu',
    // First-run onboarding
    onbTitle1: 'Selamat datang ke Codexoffice',
    ...
    onbTitle2: 'Sambungkan Codex',
    onbBody2:
      'Sebelum menggunakan AI, log masuk ke Codex dalam aplikasi ini dengan akaun ChatGPT / OpenAI anda.',
    onbAccountNote:
      '**Log masuk Codex kekal dalam aplikasi ini.** Ia tidak menggunakan atau mengubah sesi Codex lain.',
    onbSkip: 'Langkau',
    onbNext: 'Seterusnya',
    onbStart: 'Mula',
    ...
    onbNote3: 'Penggunaan AI mengikut pelan OpenAI dan had penggunaan anda.',
    onbBack: 'Kembali',
  },
  he: {
    navRecent: 'אחרונים',
    ...
    untitled: 'ללא שם',
    noContent: '(ריק)',
    accountCodex: 'חשבון Codex של האפליקציה הזו',
    codexAccount: 'חשבון Codex',
    account: 'חשבון',
    login: 'התחברות',
    loginCodex: 'התחברות ל-Codex באפליקציה הזו',
    loggedIn: 'מחובר',
    loggedInCodex: 'מחובר ל-Codex באפליקציה הזו',
    ...
    loginCopied: 'הועתק',
    loginNetworkError: 'לא ניתן להתחבר ל-Codex — בדקו את הרשת או את הגדרות ה-proxy',
    loginExpired: 'תוקף ההרשאה פג — לחצו כדי לנסות שוב',
    loginFailed: 'ההתחברות נכשלה — לחצו כדי לנסות שוב',
    loggingOut: 'מתנתק…',
    logout: 'התנתקות מהאפליקציה הזו בלבד',
    appVersion: 'גרסה {v}',
    versionLabel: 'גרסה',
    today: 'היום',
    yesterday: 'אתמול',
    ...
    // First-run onboarding
    onbTitle1: 'ברוכים הבאים ל-Codexoffice',
    ...
    onbTitle2: 'חיבור Codex',
    onbBody2: 'לפני שימוש ב-AI, התחברו ל-Codex באפליקציה הזו באמצעות חשבון ChatGPT / OpenAI.',
    onbAccountNote:
      '**ההתחברות ל-Codex נשמרת באפליקציה הזו.** היא לא משתמשת בהפעלות Codex אחרות ולא משנה אותן.',
    onbSkip: 'דילוג',
    onbNext: 'הבא',
    onbStart: 'להתחיל',
    ...
    onbNote3: 'השימוש ב-AI כפוף לתוכנית OpenAI ולמגבלות השימוש שלכם.',
    onbBack: 'חזרה',
  },
  hi: {
    navRecent: 'हाल के',
    ...
    noContent: '(खाली)',
    accountCodex: 'इस ऐप का Codex खाता',
    codexAccount: 'Codex खाता',
    account: 'खाता',
    login: 'साइन इन करें',
    loginCodex: 'इस ऐप में Codex में साइन इन करें',
    loggedIn: 'साइन इन हो गया',
    loggedInCodex: 'इस ऐप में Codex में साइन इन है',
    waitingLogin:
    ...
    loginNetworkError: 'Codex से कनेक्ट नहीं हो सका — नेटवर्क या प्रॉक्सी सेटिंग जांचें',
    ...
    logout: 'केवल इस ऐप से साइन आउट करें',
    ...
    newTab: 'नया टैब',
    // First-run onboarding
    onbTitle1: 'Codexoffice में आपका स्वागत है',
    ...
    onbTitle2: 'Codex कनेक्ट करें',
    onbBody2:
      'AI का उपयोग करने से पहले इस ऐप में अपने ChatGPT / OpenAI खाते से Codex में साइन इन करें।',
    onbAccountNote:
      '**Codex साइन-इन केवल इस ऐप में रहता है।** यह अन्य Codex सत्रों का उपयोग या बदलाव नहीं करता।',
    onbSkip: 'छोड़ें',
    onbNext: 'आगे',
    onbStart: 'शुरू करें',
    ...
    onbNote3: 'AI उपयोग आपके OpenAI प्लान और उपयोग सीमाओं के अनुसार होता है।',
    onbBack: 'वापस',
  },
  'zh-TW': {
    navRecent: '最近',
    ...
    untitled: '未命名',
    noContent: '（無內容）',
    accountCodex: '此應用程式的 Codex 帳號',
    codexAccount: 'Codex 帳號',
    account: '帳號',
    login: '登入',
    loginCodex: '在此應用程式中登入 Codex',
    loggedIn: '已登入',
    loggedInCodex: '已在此應用程式中登入 Codex',
    ...
    loginCopyUrl: '複製登入連結',
    loginCopied: '已複製',
    loginNetworkError: '無法連線至 Codex，請檢查網路或代理設定',
    ...
    newTab: '新分頁',
    // First-run onboarding
    onbTitle1: '歡迎使用 Codexoffice',
    onbSubtitle1: '第一個開源的 AI 原生 Office 套件',
    onbBody1: '建立文件、製作試算表、產生簡報、審閱 PDF。AI 深度融入每個環節。',
    onbTitle2: '連接 Codex',
    onbBody2: '使用 AI 前，請在此應用程式中使用你的 ChatGPT / OpenAI 帳號登入 Codex。',
    onbAccountNote: '**Codex 登入僅保存在此應用程式中。** 不會使用或變更其他 Codex 工作階段。',
    onbSkip: '略過',
    onbNext: '下一步',
    onbStart: '開始使用',
    ...
    onbNote3: 'AI 使用量受你的 OpenAI 方案和使用限制約束。',
    onbBack: '上一步',
  },
} as const
