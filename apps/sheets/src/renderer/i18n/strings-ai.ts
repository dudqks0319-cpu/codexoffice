...
export const aiStrings = defineStrings({
  zh: {
    ...
    aiCodexAccount: 'Codex account',
    aiAccountChecking: '检测中…',
    aiLoggedIn: '已登录',
    aiLoggedInAs: '已登录：{email}',
    aiNotLoggedIn: 'Not signed in (uses your local Codex account)',
    aiWaitingBrowserLogin: '等待浏览器登录…',
    aiLoginCodex: 'Sign in with your Codex account',
    aiModel: '模型',
    aiModelHint: '留空以使用 Codex SDK 默认模型',
    aiCancel: '取消',
    aiSave: '保存',
    aiUnknownError: '未知错误',
    aiTimeoutError: 'AI 请求超时：网络长时间无响应，已停止。请检查网络后重试',
    aiCreditsExhausted: 'Codex usage limit reached. Check your Codex/ChatGPT plan, then try again.',
  ...
  en: {
    ...
    aiLoginCodex: 'Sign in with your Codex account',
    aiModel: 'Model',
    aiModelHint: 'Leave blank to use the Codex SDK default',
    aiCancel: 'Cancel',
    aiSave: 'Save',
  ...
  ja: {
    ...
    aiLoginCodex: 'Sign in with your Codex account',
    aiModel: 'モデル',
    aiModelHint: '空欄にすると Codex SDK の既定モデルを使用します',
    aiCancel: 'キャンセル',
    aiSave: '保存',
  ...
  ko: {
    ...
    aiLoginCodex: 'Sign in with your Codex account',
    aiModel: '모델',
    aiModelHint: '비워 두면 Codex SDK 기본 모델을 사용합니다',
    aiCancel: '취소',
    aiSave: '저장',
  ...
  fr: {
    ...
    aiLoginCodex: 'Sign in with your Codex account',
    aiModel: 'Modèle',
    aiModelHint: 'Laissez vide pour utiliser le modèle par défaut du SDK Codex',
    aiCancel: 'Annuler',
    aiSave: 'Enregistrer',
  ...
  de: {
    ...
    aiLoginCodex: 'Sign in with your Codex account',
    aiModel: 'Modell',
    aiModelHint: 'Leer lassen, um das Standardmodell des Codex SDK zu verwenden',
    aiCancel: 'Abbrechen',
    aiSave: 'Speichern',
  ...
  es: {
    ...
    aiLoginCodex: 'Sign in with your Codex account',
    aiModel: 'Modelo',
    aiModelHint: 'Déjalo vacío para usar el modelo predeterminado del SDK de Codex',
    aiCancel: 'Cancelar',
    aiSave: 'Guardar',
  ...
  th: {
    ...
    aiLoginCodex: 'Sign in with your Codex account',
    aiModel: 'โมเดล',
    aiModelHint: 'เว้นว่างไว้เพื่อใช้โมเดลเริ่มต้นของ Codex SDK',
    aiCancel: 'ยกเลิก',
    aiSave: 'บันทึก',
  ...
  id: {
    ...
    aiLoginCodex: 'Sign in with your Codex account',
    aiModel: 'Model',
    aiModelHint: 'Kosongkan untuk menggunakan model default Codex SDK',
    aiCancel: 'Batal',
    aiSave: 'Simpan',
  ...
  ru: {
    ...
    aiLoginCodex: 'Sign in with your Codex account',
    aiModel: 'Модель',
    aiModelHint: 'Оставьте пустым, чтобы использовать модель Codex SDK по умолчанию',
    aiCancel: 'Отмена',
    aiSave: 'Сохранить',
  ...
  ar: {
    ...
    aiLoginCodex: 'Sign in with your Codex account',
    aiModel: 'النموذج',
    aiModelHint: 'اتركه فارغًا لاستخدام النموذج الافتراضي لـ Codex SDK',
    aiCancel: 'إلغاء',
    aiSave: 'حفظ',
  ...
  pt: {
    ...
    aiLoginCodex: 'Sign in with your Codex account',
    aiModel: 'Modelo',
    aiModelHint: 'Deixe em branco para usar o modelo padrão do SDK Codex',
    aiCancel: 'Cancelar',
    aiSave: 'Salvar',
  ...
  it: {
    ...
    aiLoginCodex: 'Sign in with your Codex account',
    aiModel: 'Modello',
    aiModelHint: 'Lascia vuoto per usare il modello predefinito dell’SDK Codex',
    aiCancel: 'Annulla',
    aiSave: 'Salva',
  ...
  pl: {
    ...
    aiLoginCodex: 'Sign in with your Codex account',
    aiModel: 'Model',
    aiModelHint: 'Pozostaw puste, aby użyć domyślnego modelu Codex SDK',
    aiCancel: 'Anuluj',
    aiSave: 'Zapisz',
  ...
  nl: {
    ...
    aiLoginCodex: 'Sign in with your Codex account',
    aiModel: 'Model',
    aiModelHint: 'Laat leeg om het standaardmodel van de Codex SDK te gebruiken',
    aiCancel: 'Annuleren',
    aiSave: 'Opslaan',
  ...
  ms: {
    ...
    aiLoginCodex: 'Sign in with your Codex account',
    aiModel: 'Model',
    aiModelHint: 'Biarkan kosong untuk menggunakan model lalai Codex SDK',
    aiCancel: 'Batal',
    aiSave: 'Simpan',
  ...
  he: {
    ...
    aiLoginCodex: 'Sign in with your Codex account',
    aiModel: 'מודל',
    aiModelHint: 'השאר ריק כדי להשתמש במודל ברירת המחדל של Codex SDK',
    aiCancel: 'ביטול',
    aiSave: 'שמירה',
  ...
  hi: {
    ...
    aiLoginCodex: 'Sign in with your Codex account',
    aiModel: 'मॉडल',
    aiModelHint: 'Codex SDK के डिफ़ॉल्ट मॉडल का उपयोग करने के लिए खाली छोड़ें',
    aiCancel: 'रद्द करें',
    aiSave: 'सहेजें',
  ...
  'zh-TW': {
    ...
    aiLoginCodex: 'Sign in with your Codex account',
    aiModel: '模型',
    aiModelHint: '留白以使用 Codex SDK 預設模型',
    aiCancel: '取消',
    aiSave: '儲存',
    aiUnknownError: '未知錯誤',
