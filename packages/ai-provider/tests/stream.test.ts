...
describe('streamForProvider: 200 + non-stream JSON instead of SSE', () => {
  const creditsNotice =
    'Your provider credits have been exhausted. Please visit the pricing page to purchase more credits.'
      ...
      vi.fn().mockResolvedValue(
        json({
          candidates: [
            {
              content: {
                parts: [{ text: 'Out of quota, visit the pricing page to top up.' }],
              },
            },
          ],
