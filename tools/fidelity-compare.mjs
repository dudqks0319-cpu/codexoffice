 ...
 * Our side: playwright drives the packaged Codexoffice Slides (Electron) with zoom locked at 100%,
...
/**
 * Opens Codexoffice Slides and, page by page, composites the main canvas's Konva layers into a PNG
...
<table><tr><td>reference<br><img src="${rel(r.ref)}"></td><td>Codexoffice Slides<br><img src="${rel(r.ours)}"></td><td>diff<br><img src="${rel(r.diff)}"></td></tr></table>`,
  )
  .join('')}
`
